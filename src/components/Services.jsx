        ...
        <div className="container lg:py-15 py-15 flex flex-col items-center">
            <div className="mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-6">
                    <div className="bg-[#FFFFF0] p-6 rounded-3xl shadow-md">
                        <img src="/public/Services/1.jpg" alt="Electrical Design" className="w-full h-48 object-cover rounded-[14px] mb-4" />
                    ...
                    <div className="bg-[#FFFFF0] p-6 rounded-3xl shadow-md">
                        <img src="/public/Services/3.jpeg" alt="Cable Tray Fabrication" className="w-full h-48 object-cover rounded-[14px] mb-4" />
